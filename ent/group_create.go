...
func (_c *GroupCreate) AddPersonIDs(ids ...int) *GroupCreate {
	_c.mutation.AddPersonIDs(ids...)
	return _c
}

// AddPeople adds the "people" edges to the Person entity.
func (_c *GroupCreate) AddPeople(v ...*Person) *GroupCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *GroupCreate) AddEventIDs(ids ...int) *GroupCreate {
...
func (_c *GroupCreate) AddNoteIDs(ids ...int) *GroupCreate {
	_c.mutation.AddNoteIDs(ids...)
	return _c
}

// AddNotes adds the "notes" edges to the GroupNote entity.
func (_c *GroupCreate) AddNotes(v ...*GroupNote) *GroupCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
