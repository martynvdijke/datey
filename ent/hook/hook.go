...
// The GiftIdeaFunc type is an adapter to allow the use of ordinary
// function as GiftIdea mutator.
type GiftIdeaFunc func(context.Context, *ent.GiftIdeaMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GiftIdeaFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GiftIdeaMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GiftIdeaMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f MigrationLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MigrationLogMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f RecurringRuleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RecurringRuleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RecurringRuleMutation", m)
}
...
// The UserNotificationChannelFunc type is an adapter to allow the use of ordinary
// function as UserNotificationChannel mutator.
type UserNotificationChannelFunc func(context.Context, *ent.UserNotificationChannelMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserNotificationChannelFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserNotificationChannelMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserNotificationChannelMutation", m)
}
