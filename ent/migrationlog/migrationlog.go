...
const (
	// Label holds the string label denoting the migrationlog type in the database.
	Label = "migration_log"
	...
	// Table holds the table name of the migrationlog in the database.
	Table = "migration_logs"
)

// Columns holds all SQL columns for migrationlog fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldAppliedAt,
...
// OrderOption defines the ordering options for the MigrationLog queries.
