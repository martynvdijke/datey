...
func (e TagEdges) PeopleOrErr() ([]*Person, error) {
	if e.loadedTypes[0] {
		return e.People, nil
	}
...
// QueryPeople queries the "people" edge of the Tag entity.
func (_m *Tag) QueryPeople() *PersonQuery {
	return NewTagClient(_m.config).QueryPeople(_m)
}
